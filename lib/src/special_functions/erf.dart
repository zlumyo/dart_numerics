...
double _erfInvImpl(double p, double q, double s) {
  ...
  if (p <= 0.5) {
    ...
    double g = p * (p + 10);
    double r = Polynomial.evaluate(p, _ervInvImpAn) /
    ...
    double g = stdmath.sqrt(-2 * stdmath.log(q));
    double xs = q - 0.25;
    double r = Polynomial.evaluate(xs, _ervInvImpBn) /
    ...
    double x = stdmath.sqrt(-stdmath.log(q));
    if (x < 3) {
      // Max error found: 1.089051e-20
      const double y = 0.807220458984375;
      double xs = x - 1.125;
      double r = Polynomial.evaluate(xs, _ervInvImpCn) /
      ...
      double xs = x - 3;
      double r = Polynomial.evaluate(xs, _ervInvImpDn) /
      ...
      double xs = x - 6;
      double r = Polynomial.evaluate(xs, _ervInvImpEn) /
      ...
      double xs = x - 18;
      double r = Polynomial.evaluate(xs, _ervInvImpFn) /
      ...
      double xs = x - 44;
      double r = Polynomial.evaluate(xs, _ervInvImpGn) /
